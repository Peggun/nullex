...
// This file: <src/utils/bitflags/mod.rs>
...
macro_rules! __impl_bitflags {
    (
        ...
        impl $PublicBitFlags {
            ...
            #[inline]
            pub const fn from_bits($bits: $T) -> $crate::utils::bitflags::__private::core::option::Option<Self>
                $from_bits_body
            ...
            #[inline]
            pub fn from_name($name: &str) -> $crate::utils::bitflags::__private::core::option::Option<Self>
                $from_name_body
