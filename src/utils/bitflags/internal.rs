...
// This file: <src/utils/bitflags/internal.rs>
...
macro_rules! __impl_internal_bitflags {
    (
        ...
        // retained somehow
        impl $crate::utils::bitflags::__private::PublicFlags for $PublicBitFlags {
            type Primitive = $T;
            type Internal = $InternalBitFlags;
        }

        impl $crate::utils::bitflags::__private::core::default::Default for $InternalBitFlags {
            #[inline]
            fn default() -> Self {
        ...
        impl $crate::utils::bitflags::__private::core::fmt::Debug for $InternalBitFlags {
            fn fmt(&self, f: &mut $crate::utils::bitflags::__private::core::fmt::Formatter<'_>) -> $crate::utils::bitflags::__private::core::fmt::Result {
                if self.is_empty() {
                    ...
                    // just like `0x0` does.
                    $crate::utils::bitflags::__private::core::write!(f, "{:#x}", <$T as $crate::utils::bitflags::Bits>::EMPTY)
                } else {
                    $crate::utils::bitflags::__private::core::fmt::Display::fmt(self, f)
                }
            }
        }

        impl $crate::utils::bitflags::__private::core::fmt::Display for $InternalBitFlags {
            fn fmt(&self, f: &mut $crate::utils::bitflags::__private::core::fmt::Formatter<'_>) -> $crate::utils::bitflags::__private::core::fmt::Result {
                $crate::utils::bitflags::parser::to_writer(&$PublicBitFlags(*self), f)
            }
        }

        impl $crate::utils::bitflags::__private::core::str::FromStr for $InternalBitFlags {
            type Err = $crate::utils::bitflags::parser::ParseError;

            fn from_str(s: &str) -> $crate::utils::bitflags::__private::core::result::Result<Self, Self::Err> {
                $crate::utils::bitflags::parser::from_str::<$PublicBitFlags>(s).map(|flags| flags.0)
            }
        }

        impl $crate::utils::bitflags::__private::core::convert::AsRef<$T> for $InternalBitFlags {
            fn as_ref(&self) -> &$T {
                &self.0
            }
        }

        impl $crate::utils::bitflags::__private::core::convert::From<$T> for $InternalBitFlags {
            fn from(bits: $T) -> Self {
