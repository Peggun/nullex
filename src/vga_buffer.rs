...
impl Writer {
	...
	/// bg_color). Example: write_segments(&[("test", Color::Green,
	/// Color::Black), ("@nullex", Color::White, Color::Black)]);
...
///   ("text", Color::SomeColor)                      -> background defaults to
/// Color::Black   ("text", Color::SomeColor, Color::OtherColor)  -> explicit
/// background
///
/// Examples:
