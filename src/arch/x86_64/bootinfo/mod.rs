...
// Modifications: Removed unused features, and removed `cfg` for map_physical_memory and embedded it natively. Made externs unsafe. `mod memory_map` to be public.
