...
//   Upstream original file: <src/bootinfo/memory_map.rs>
// Copyright (c) 2018 Philipp Oppermann
// Modifications: Removed unused features, and removed `cfg` for map_physical_memory and embedded it natively. Made externs unsafe.
